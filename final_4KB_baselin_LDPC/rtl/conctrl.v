module conctrl (
        ...
        input wire [532:0] flag_VFU_end,       //VFU模块更新完成
        input wire [20:0] flag_CFU_end,       //CFU模块更新完成
    ...
    always @(posedge sys_clk or negedge sys_rst_n)
        ...
        else if (flag_org_write_end == 1'b1 || (flag_CFU_end == {21{1'b1}}))
